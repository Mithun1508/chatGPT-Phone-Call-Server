...
if __name__ == "__main__":
  ...
  server.app.get("/")(lambda: Response(
    content=
    f"<div>Fork this Repl and see README.md for instructions! Don't forget to paste your Repl's URL into your Twilio config like this: {REPLIT_URL}/vocode<br><br>Watch the <a href='' target='_blank'>live demo</a> to see it in action!</div>",
